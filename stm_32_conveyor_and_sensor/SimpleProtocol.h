...
int SimPro_Packet(SimpleProtocol *SIMPRO, void *buffer, int buf_size);//编码，封装协议
void SimPro_EnChar(SimpleProtocol *SIMPRO, uint8_t byte);//塞一个字节进入协议缓冲区
int SimPro_UnPacking(SimpleProtocol *SIMPRO);//尝试解析协议
